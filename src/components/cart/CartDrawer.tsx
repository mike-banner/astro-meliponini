              ...
              <div key={item.item_key} className="flex gap-4 items-start border-b border-border/50 pb-6 relative">
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    ...
                    <span className="font-semibold text-sm text-black whitespace-nowrap flex-shrink-0">{price} €</span>
                  </div>
                </div>
        ...
        {$cart.items.length > 0 && (
          <SheetFooter className="p-6 border-t border-border bg-zinc-50 flex-col gap-4">
            <div className="flex justify-between items-center w-full uppercase tracking-widest text-sm font-semibold">
              <span>Total</span>
              <span className="text-lg text-black">{$cart.totals.total}</span>
            </div>
            ...
            <div className="flex flex-col gap-2 w-full mt-4">
              <Button 
                ...
                className="w-full h-12 uppercase tracking-widest text-xs relative overflow-hidden group"
              >
